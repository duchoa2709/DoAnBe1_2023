...
<a href="update_protypes.php?type_id=<?php echo $value['type_id'] ?>"> <i class="fa fa-edit"></i></a>    
...
<a href="del_protypes.php?type_id=<?php echo $value['type_id'] ?>">X</a>    
                                    ...
                                    <a class="btn btn-primary btn-sm" href="./product.php?type_id=<?php echo $value['type_id'] ?>">
