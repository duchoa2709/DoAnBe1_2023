                        ...
                        <tr>
                            ...
                            <td data-th="Product">
                                <div class="row">
                                    ...
                                    <div class="col-sm-3 hidden-xs"><img src="../img/<?php echo $value['image'] ?>"
                                    ...
                                    <div class="col-sm-7">
                                        ...
                                        <p>
                                            ...
                                            <?php echo "      manu_id :" . $value['manu_id'] ?>
                                        </p>
                                        <p>
                            ...
                            <td class="actions" data-th="">
                                ...
                                <button class="btn btn-info btn-sm">
                                    <a href="update_product.php?id=<?php echo $value['id'] ?>"> <i
                                            class="fa fa-edit"></i></a>

                                </button>
                                <button class="btn btn-danger btn-sm">
                                    <a href="del_product.php?id=<?php echo $value['id'] ?>">X</a>
