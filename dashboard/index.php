	...
	$protypes = new Protypes;
                ...
                if($count != null && $count > 0){
                  ...
                  if($count_manu != null && count($count_manu) > 0){
                    ...
                    $number_manu = $count_manu[0]['number'];
                    
              }
              if($count_type != null && count($count_type) > 0){
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-6">
                                ...
                                <div class="small-box bg-success">
                                    ...
                                    <a href="./Manufacture.php" class="small-box-footer">More info <i
                                            class="fas fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
                            <!-- ./col -->
                            <div class="col-lg-3 col-6">
                                ...
                                <div class="small-box bg-warning">
                                    ...
                                    <a href="./Protypes.php" class="small-box-footer">More info <i
                                            class="fas fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
                            <!-- ./col -->
