...
<div class="container">
    <table id="cart" class="table table-hover table-condensed">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td data-th="Quantity"><input class="form-control text-center" value="<?php echo $value['soluong'] ?>"
                        type="">
                </td>
                <?php
  ...
  $tongTien += $thanhtien;
   ...
   ?>
                ...
                <td><a href="checkout.php" class="btn btn-success btn-block">Thanh toán <i
